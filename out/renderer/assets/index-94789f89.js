...
const wyvern = "" + new URL("wyvern-93f71169.png", import.meta.url).href;
const fishbone = "" + new URL("fishbone-4ff2b4dd.png", import.meta.url).href;
const wheat = "" + new URL("wheat-e6d9ea64.png", import.meta.url).href;
const winged = "" + new URL("winged-sword-0787ba58.png", import.meta.url).href;
const mermaid = "" + new URL("mermaid-a13e5aa3.png", import.meta.url).href;
const fairy = "" + new URL("fairy-ec06b0df.png", import.meta.url).href;
const ghost = "" + new URL("ghost-23b82516.png", import.meta.url).href;
const data = [{
  id: 1,
  url: wyvern
}, {

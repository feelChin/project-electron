...
const render = "_render_1d8ag_1";
const enter = "_enter_1d8ag_32";
const leave = "_leave_1d8ag_35";
const style = {
  render,
  enter,
  leave
...
function Index() {
  ...
  }), /* @__PURE__ */ React.createElement("p", null, "外部是哈希路由 内部更改哈希会改变全局"), /* @__PURE__ */ React.createElement("div", {
    style: {
      height: 30
    }

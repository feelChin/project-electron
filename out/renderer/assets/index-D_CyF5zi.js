...
const mainRouter = [{
  path: "/",
  name: "首页",
  element: () => __vitePreload(() => import("./index-f8V2vtZL.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url)
}, {
  path: "/example",
  name: "例子",
  element: () => __vitePreload(() => import("./index-BRkvyhrA.js"), true ? __vite__mapDeps([2,3,4,5]) : void 0, import.meta.url)
}];
const routes = [{
  path: "/",
  element: () => __vitePreload(() => import("./index-znxYQ_ES.js"), true ? __vite__mapDeps([6,4,7]) : void 0, import.meta.url),
  children: mainRouter
}, {
  path: "/loadingPage",
  name: "启动加载",
  element: () => __vitePreload(() => import("./index-QAeE347p.js"), true ? __vite__mapDeps([8,3,9]) : void 0, import.meta.url)
}, {
  path: "/updatePage",
  name: "更新程序窗口",
  element: () => __vitePreload(() => import("./index-_AmU0wEr.js"), true ? __vite__mapDeps([10,11]) : void 0, import.meta.url)
}, {
  path: "*",
  name: "更新程序窗口",
  element: () => __vitePreload(() => import("./index-f8V2vtZL.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url)
...
function Index() {
  function LazyElement({
    ...
    const LazyComponent = reactExports.lazy(importFunc);
    return /* @__PURE__ */ React.createElement(reactExports.Suspense, {
      fallback: ""
    }, /* @__PURE__ */ React.createElement(LazyComponent, null));
  }
  function dealRoutes(data2, result = []) {
    data2.forEach((router) => {
      if (router.element && typeof router.element == "function") {
        router.element = /* @__PURE__ */ React.createElement(LazyElement, {
          key: router.path,
          importFunc: router.element
        });
      }
      if (router.children) {
...
const data = [
  ...
  },
  {
    type: "vanilla",
    name: "手写promise并发",
    text: "支持2-6位并发控制，并返回数组知道成功与失败状态",
    url: "promiseLimit"
  },
  {
    type: "vanilla",
    name: "自定义路由切换",
    text: "封装路由切换 支持哈希路由与history路由",
    url: "customRoute"
  },
  {
    type: "vanilla",
    name: "公告栏无限滚动",
    text: "公告栏无限滚动动画  支持上下左右或连续",
    url: "noticeLoopScroll"
  },
  {
    type: "vanilla",
    name: "虚拟列表-滚动加载",
    text: "原生js自定义滚动条 拖拽滚动 虚拟列表",
    url: "virtualLoop"
  },
  {
    type: "react",
    name: "虚拟列表-10000条",
    text: "拖拽时不会白屏（劫持滚动，列表更新后在滚动）",
    url: "virtualList"
  },
  {
    type: "react",
    name: "自定义滚动-劫持滚动",
    text: "模拟滚动条 滚动行为支持动画 支持滚动结束 滚动之前方法",
    url: "custonScrollTheme"
  },
  {
    type: "react",
    name: "倒计时",
    text: "倒计时组件，支持倒计回调、调整服务器时间基准等",
    url: "timeCountDown"
  },
  {
    type: "react",
  ...
  },
  {
    type: "react",
    name: "无限列表",
    text: "监听元素是否可视化，滚动时到列表底部时，增加数据",
    url: "intersectionObserverScrollList"
  },
  {
    type: "vanilla",
    name: "Web Socket 封装",
    text: "原生js 简易的Web Socket 封装，支持心跳",
    url: "websocket"
  },
  {
    type: "react",
    name: "Message消息组件",
    text: "使用React.Render渲染组件  CSS3动画进行消息的显示隐藏",
    url: "message"
  },
  {
    type: "react",
    name: "车牌号选择器",
    text: "自定义软键盘 实现中国省份 数字 字母 进行车牌号选择",
    url: "plateKeyboard"
  },
  {
    type: "react",
  ...
  },
  {
    type: "react",
    name: "表格增删",
    text: "实现表格行增加删除渲染数据的功能",
    url: "tableAddAndRemove"
  },
  {
    type: "react",
    name: "实现购物车功能",
    text: "自定义Reducer实现购物车增删计算，使用贝塞尔曲线动画",
    url: "shoppingCart"
  },
  {
    type: "react",
    name: "Tree封装",
    text: "antd Tree组件实现增加删除修改插入保存功能",
    url: "tree"
  },
  {
    type: "react",
    name: "Modal弹窗组件",
    text: "使用createPortal实现弹窗，支持静态方法",
    url: "myModal"
  },
  {
    type: "vanilla",
    name: "鼠标移入/点击元素高度增减动画",
    text: "暂停元素高度 操作时通过css使用高度变化动画",
    url: "accordion"
  },
  {
    type: "vanilla",
  ...
  },
  {
    type: "vanilla",
    name: "文字分割动画",
    text: "分割文字 可配置间隔速度 延迟时间 随机 换行 标记",
    url: "splitText"
  },
  {
    type: "vanilla",
  ...
  },
  {
    type: "vanilla",
    name: "导航线条跟随动画",
    text: "可选 mouseover 和 click两种形态 css动画操作",
    url: "followArrow"
  },
  {
    type: "vanilla",
    name: "图片懒加载",
    text: "基于IntersectionObserver实现 检测到视口范围加载图片",
    url: "loadingImg"
  },
  {
    type: "vanilla",
    name: "元素与鼠标方向相反动画",
    text: "基于IntersectionObserver实现 检测到视口范围加载图片",
    url: "mouseDocumengtMove"
  },
  {
    type: "vanilla",
    name: "元素滚动动画",
    text: "经过滚动计算 实现随着页面滚动元素发生对应动画",
    url: "scrollPageFollowAnimation"
  },
  {
    type: "vanilla",
    name: "页面缓动滚动",
    text: "使用transform 模拟页面滚动,产生缓动过渡滚动",
    url: "scrollPageTransfrom"
  },
  {
    type: "vanilla",
    name: "页面横向缓动滚动",
    text: "使用transform 页面横屏滚动,产生缓动过渡滚动",
    url: "scrollPageTransfromHorizontally"
  },
  {
    type: "vanilla",
    name: "元素可见动画",
  ...
  },
  {
    type: "vanilla",
    name: "文章目录自动高亮",
    text: "浏览文章 文章目录会高亮此章节 点击章节滚动到该文章",
    url: "scrollpageActive"
  },
  {
    type: "vanilla",
    name: "滚动播放帧图片",
    text: "判断滚动距离 展示不同的帧图片",
    url: "imgToVideo"
  },
  {
    type: "vanilla",
    name: "鼠标跟随小圆点",
    text: "通过鼠标移动 创建一个小点进行跟随动画",
    url: "mouseFollow"
  },
  {
    type: "vanilla",
  ...
  },
  {
    type: "react",
    name: "音乐播放",
    text: "音乐播放 实现播放暂停 拉进度条 歌词渲染 歌词同步",
    url: "music"
  }
];
const exampleList = {
...
const RootProvider = ({
  ...
  reactExports.useEffect(() => {
    document.documentElement.setAttribute("data-theme", userInfo.theme ? "light" : "dark");
  }, [userInfo.theme]);
  const value = {
    userInfo,
    setUserInfo
...
root.render(/* @__PURE__ */ React.createElement(HashRouter, null, /* @__PURE__ */ React.createElement(RootProvider, null, /* @__PURE__ */ React.createElement(Index, null))));
export {
  Outlet as O,
  React as R,
  __vitePreload as _,
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["./index-f8V2vtZL.js","./index-8sRJDttA.css","./index-BRkvyhrA.js","./index-2YrWd7R0.js","./useContext-g9HRhlmq.js","./index-logA2p1W.css","./index-znxYQ_ES.js","./index-xcnemJBw.css","./index-QAeE347p.js","./index-R8be-Nph.css","./index-_AmU0wEr.js","./index-buxQ_QGb.css"]
  }
